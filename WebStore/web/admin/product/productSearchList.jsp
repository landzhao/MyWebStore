...
<form action="${pageContext.request.contextPath }/admin/ProductServlet" method="post"
      onsubmit="return checkInput()" onkeypress="if(13 === event.keyCode){jump();return false;}">
                                    ...
                                    <td width="49">
                                        <div align="center">
                                            <span class="STYLE22"><a
                                                    href="javascript:searchPageSplit(${page.totalPageNum })">尾页</a></span>
                                        </div>
                                    </td>
...
<script type="text/javascript">
    ...
    function jump() {
        ...
        searchPageSplit(num);
        <%--window.location.href = "${pageContext.request.contextPath }/ProductServlet?op=multiConditionSearchProduct&num=" + num;--%>
    }

    function searchPageSplit(num) {
        var param = "&pid=${condition.pid}&pname=${condition.pname}&cid=${condition.cid}&minPrice=${condition.minPrice}&maxPrice=${condition.maxPrice}";
        window.location.href = "${pageContext.request.contextPath }/admin/ProductServlet?op=multiConditionSearchProduct&num=" + num + param;
    }
